...
var intersection = {
    ...
    greenNS: function() {
        ...
        setTimeout(intersection.yellowNS, (intersection.greenLengthNS)*1000/time);
    },
    yellowNS: function() {
    ...
    redNS: function() {
        ...
        setTimeout(intersection.greenNS, (intersection.greenLengthWE+intersection.yellowLength)*1000/time);
        setTimeout(intersection.yellowWE, intersection.greenLengthWE*1000/time);
    },
    yellowWE: function() {
    ...
    if(carnum < data.trafficintensity && data.collecting) {
        ...
        setTimeout(function() {
            switch(Math.floor(Math.random() * 12)) {
                ...
                case 3:
                case 4:
                    cars.push(new Car(280, 0, 90, Math.floor(Math.random() * 3) - 1));
                    break;
                case 5:
                case 6:
                case 7:
...
document.getElementById("startbtn").addEventListener("click", function() {
    ...
    /*setTimeout(function() {
        data.collecting = false;
        console.log((data.flowtotal/6 * 5300/timer)+" "+timer);
        data.flowtotal = 0;
    }, 21600000/time);*/
});
